...
import id.web.designer.worldhistory.util.IabBroadcastReceiver;
import id.web.designer.worldhistory.util.IabHelper;
import id.web.designer.worldhistory.util.IabResult;
import id.web.designer.worldhistory.util.Inventory;
import id.web.designer.worldhistory.util.NetworkHandler;
import id.web.designer.worldhistory.util.PermissionUtil;
import id.web.designer.worldhistory.util.Pref;
import id.web.designer.worldhistory.util.ProgressDialogHelper;
import id.web.designer.worldhistory.util.Purchase;
import id.web.designer.worldhistory.util.UrlHander;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener, DownloadListener, IabBroadcastReceiver.IabBroadcastListener {
    ...
    private void checkURL(Intent intent) {
        ...
        if (TextUtils.isEmpty(target_url)) {
            target_url = "file:///android_asset/1.html";
